...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <!-- Navbar content for the left panel -->
                                ...
                                <table class="table" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= isset($trans->jam_in) ? $trans->jam_in : 'N/A' ?> - <?= isset($trans->jam_out) ? $trans->jam_out : 'N/A' ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="<?=site_url('Transaksi/reject/'.$trans->id)?>">Reject</a>
                                            </td>
                                        </tr>
                                    <?php 
                                        } 
